...
type ConfigTabsCustomDomainSectionProps = {
	...
	setHostedSubdomainStatus: (status: HostedSubdomainStatus) => void;
...
export function ConfigTabsCustomDomainSection({
	...
	return (
		<ConfigTabsSectionLayout
			...
			description="Public URL for accessing your application on our domain"
		>
			<div className="w-full max-w-sm space-y-3">
				<FormField
					control={form.control}
					name="hostedSubdomain"
					render={({ field }) => (
						<FormItem>
							<FormControl>
								<div className="relative group ">
									...
									<div className="absolute right-3.5 top-1/2 -translate-y-1/2 flex items-center gap-2 pointer-events-none">
										...
										{hostedSubdomainVerifying && <RotateCw className="size-3 animate-spin text-primary" />}
					...
					<Alert
						className={`py-2 px-3 rounded-lg border-none ${
							hostedSubdomainStatus.type === "error"
								...
								: hostedSubdomainStatus.type === "owned"
