	...
	return (
		<>
			...
			>
				...
				<ScrollArea
					className={`${scrollable ? "h-[min(31.25rem,calc(100svh-13rem))] min-h-72 overflow-y-auto sm:h-[500px]" : "h-auto"} w-full min-w-0 rounded-md border border-border bg-card`}
					data-logs-scroll
				>
